...
const Home = async () => {
  ...
  return (
      <div>
        ...
        <Header/>
        <div className="p-5">
          <h2 className="text-xl font-bold">Olá, {session?.user ? session.user.name : 'Visitante'}.</h2>
          <p>
        ...
        {/* Busca Rápida */}
          ...
          {/* Booking Item */}
          {confirmedBookings[0] && <h2 className="mt-6 mb-3 uppercase text-gray-400 font-bold text-xs">Agendamentos</h2>}
